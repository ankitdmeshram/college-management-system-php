      ...
      <div class="row">
        <div class="col-lg-6 border-r">
          ...
          <div class="row">
            <div class="col">
              <div class="form-group">
                <input type="password" name="password" class="form-control" placeholder="Setup New Password" required />
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col">
              <div class="form-group">
                <button type="submit" class="btn btn-warning text-white" style="float: right" name="register">
                  Create Account
                </button>
                </form>
              </div>
        ...
        <div class="col-lg-6">
          <img src="https://brokod.github.io/assets/77628-website-launch.gif" class="img-fluid" alt="" />
        </div>
      </div>
    </div>
  </section>
